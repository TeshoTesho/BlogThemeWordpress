...
<div class="blog-comments">
    ...
    <?php $comments_arg = array(
        ...
        'comment_field' => '<p>' . 
        '<textarea id="comment" class="form-control" placeholder="Digite seu comentário aqui..." name="comment" rows="3"
